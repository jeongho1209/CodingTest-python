...
//    }
    ...
    public static void main(String[] args) { // TODO: 2023/05/24 이전에 한 방문 또 하면 그게 사이클
        int cnt = 0;
...
//        Arrays.sort(Danji);
        Arrays.stream(Danji).sorted().filter(value -> value != 0).forEach(System.out::println);

//        System.out.println(Arrays.toString(Danji));
//
//        for (int i = 1; i <= cnt; i++) {
//            if(Danji[i] != 0)
